...
<body>
    <div class="container">
        <section class="chat-area">
            <header>
                <a href="home.php" class="back-icon"><img src="img/back" alt=""></a>
            ...
            <form action="" class="typing-area" method="POST">
                ...
                <button class="image"><img src="img/camera.png" alt=""></button>
                <input type="file" name="send_image" accept="image/*" class="upload_img" hidden>
                <button class="send_btn" name="send_btn"><img src="img/paper-plane.png" alt=""></button>
            </form>
        </section>
    </div>
